    ...
    <body>
                ...
                <ul id="main">
                    ...
                    <li><a href="#" style="text-decoration: none;"><span class="glyphicon glyphicon-list-alt"></span> Mi Cuenta</a>
                        <ul class="submain">
                            ...
                            <li><a href="cambiarContrasena.jsp" style="text-decoration: none;">Cambiar Contraseña</a> </li>
                           </ul>
                    </li>
        ...
        <div class="contenedor">
            <div class="lateral">
                <h4>Bienvenido</h4>
                <div class="nombre">
                    <td><input type="text" value="<%=pdto.getNombres()%>" style="width:166px; height:25px; text-align:center; text-transform:uppercase;"  autofocus disabled  class="form-control inputtext">
                    </td>
                </div>
                <div class="foto">
